...
while getgenv().autoGarden do
    ...
    for i = 1, 10 do
        ...
        if getgenv().InstaPlant then Library.Network.Invoke("Instancing_InvokeCustomFromClient", "FlowerGarden",
                "InstaGrowSeed", i) end
        if getgenv().Water then Library.Network.Invoke("Instancing_InvokeCustomFromClient", "FlowerGarden", "WaterSeed",
                i) end
