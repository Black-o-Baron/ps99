...
local Window = OrionLib:MakeWindow({Name = "Open shitty source  Pet99 Hub", HidePremium = false, SaveConfig = false, ConfigFolder = "OrionTest"})
...
Tab:AddToggle(
    {
        Name = "Auto Collect Hidden Presents",
        Default = false,
        Callback = function(v)
            Config.autoFishA = v
